                ...
                <div class="table-responsive">
                    <table class="table m-0 table-hover">
                        ...
                        while ($row = $qry->fetch_assoc()):
                            ...
                            $prog = $prog > 0 ? number_format($prog, 1) : $prog;
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm" style="    width: 75px;" href="./index.php?page=view_project&id=<?php echo $row['id'] ?>">
            ...
            <div class="col-12 col-sm-6 col-md-12">
                <div class="small-box bg-light shadow-sm border">
                    <div class="inner">
                        ...
                        <p>ITتعداد تیکت های </p>
                    </div>
                    <div class="icon">
                        <i class="fas fa-ticket-alt nav-icon" style="color:  #ff9000;opacity: 0.5;"></i>
                    </div>
                </div>
            </div>
        </div>
